...
scatterplot_umap <- vc$add_view(dataset, Component$SCATTERPLOT, mapping = "UMAP",w=8)
cell_sets <- vc$add_view(dataset, Component$CELL_SETS,w=4)
genes <- vc$add_view(dataset, Component$GENES,w=4)
